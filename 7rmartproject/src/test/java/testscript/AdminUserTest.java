...
public void VerifyIfTheUserIsableToUpdateAllTheFields()throws IOException
{
		...
		adminuserpage.clickonupdateDetailsButton().enterupdatedusername(usernameupdate).updatepassword(passwordupdate).clickonupdateDetailsButton();
		...
		objAdminUserPage.clickonupdateDetailsButton();*///write all these in the above single line 
