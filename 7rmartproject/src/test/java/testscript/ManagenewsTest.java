...
public class ManagenewsTest extends Base {
	...
	/*
	 * @Test public void VerifyIfTheUserIsAbleToDeleteNewsdeletenews() throws
	 * IOException { String
	 * loginusernamevalue=ExelUtilities.getStringData(1,0,"Loginpage"); String
	 * loginpasswordvalue=ExelUtilities.getStringData(1,1,"Loginpage"); Loginpage
	 ...
	 * //loginpage.clickOnLoginbutton(); homepage=loginpage.clickOnLoginbutton();
	 * 
	 * 
	 * 
	 ...
	 * objofManagenewspage.clickondeletebutton(); boolean
	 * alertdisplayed=objofManagenewspage.isalertdisplayed();
