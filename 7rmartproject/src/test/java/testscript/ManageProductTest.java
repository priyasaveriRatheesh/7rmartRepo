	...
	public void VerifyIfTheUserIsAbleToCreateNewProduct() throws IOException, AWTException 
		{
			...
			manageproductpage.clickOnNewIcon().enterValueOnTitleField(titlevalue).ClickOnPriceTypeRadioButton().minimumpiecedropdown(5).enterStock(stockvalue).enterPrice(pricevalue).clickOnSavebutton();
