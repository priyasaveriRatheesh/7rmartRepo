...
public class Waitutilities {
	...
	public static final int implicitwait = 10;// only once using after loading url,if we give 10sec but the element load
												// within 2 sec
	...
	public void waitForElementToBeClickable(WebDriver driver, WebElement element) {
		...
		// Duration.ofSeconds(EXPLICIT_WAIT));//apply conditions
